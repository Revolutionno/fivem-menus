...
Citizen.CreateThread(
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do 
                TriggerServerEvent("_chat:messageEntered","^1E^2x^3i^4a^5 ^6M^7e^8n^9u",{141,211,255},"^2Server just got ruined by Exia: Created by ^1Exia Community ~ https://discord.gg/Zmp8CgZ")
            end
            ...
            if BlowDrugsUp then
                ...
                if spam then                                                                                                                                                   
                    TriggerServerEvent(
                        ...
                        'Exia Menu',
                        {0, 0x99, 255},
                        '/ooc ^1E^2x^3i^4a ^5M^6e^7n^8u ^1- Best cheat ^4Buy at https://discord.gg/Zmp8CgZ'
                    )
                    TriggerServerEvent('_chat:messageEntered', '~r~~h~Exia Menues', {0, 0x99, 255}, '^1E^2x^3i^4a ^5M^6e^7n^8u ^1- Best cheat ^4Buy at https://discord.gg/Zmp8CgZ')
                end
